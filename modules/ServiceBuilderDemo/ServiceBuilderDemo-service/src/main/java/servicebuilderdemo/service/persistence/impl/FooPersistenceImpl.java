...
package servicebuilderdemo.service.persistence.impl;
...
import servicebuilderdemo.exception.NoSuchFooException;

import servicebuilderdemo.model.Foo;
import servicebuilderdemo.model.impl.FooImpl;
import servicebuilderdemo.model.impl.FooModelImpl;

import servicebuilderdemo.service.persistence.FooPersistence;
import servicebuilderdemo.service.persistence.impl.constants.FOOPersistenceConstants;
...
public class FooPersistenceImpl
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.servicebuilderdemo.model.Foo"),
			true);
	}
