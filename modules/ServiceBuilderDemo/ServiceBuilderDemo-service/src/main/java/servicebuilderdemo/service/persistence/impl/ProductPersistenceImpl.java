...
import servicebuilderdemo.model.impl.ProductImpl;
import servicebuilderdemo.model.impl.ProductModelImpl;

import servicebuilderdemo.service.persistence.ProductPersistence;
import servicebuilderdemo.service.persistence.impl.constants.RetailPersistenceConstants;
...
public class ProductPersistenceImpl
	...
	@Override
	@Reference(
		target = RetailPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.servicebuilderdemo.model.Product"),
			true);
	}
	...
	static {
		try {
			Class.forName(RetailPersistenceConstants.class.getName());
		}
