 ...
 * <code>servicebuilderdemo.service.impl.FooLocalServiceImpl</code> and
...
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>servicebuilderdemo.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static servicebuilderdemo.model.Foo addFoo(
		servicebuilderdemo.model.Foo foo) {
	 ...
	 * @return the new foo
	 */
	public static servicebuilderdemo.model.Foo createFoo(long fooId) {
	 ...
	 */
	public static servicebuilderdemo.model.Foo deleteFoo(
		servicebuilderdemo.model.Foo foo) {
	 ...
	 */
	public static servicebuilderdemo.model.Foo deleteFoo(long fooId)
	...
	public static servicebuilderdemo.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	public static servicebuilderdemo.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 * @throws PortalException if a foo with the primary key could not be found
	 */
	public static servicebuilderdemo.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static servicebuilderdemo.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<servicebuilderdemo.model.Foo> getFoos(
		int start, int end) {
	 ...
	 */
	public static java.util.List<servicebuilderdemo.model.Foo>
	...
	public static java.util.List<servicebuilderdemo.model.Foo>
		getFoosByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<servicebuilderdemo.model.Foo> orderByComparator) {
	 ...
	 */
	public static servicebuilderdemo.model.Foo updateFoo(
		servicebuilderdemo.model.Foo foo) {
